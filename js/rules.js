export const getRules = (mode) => {
  if (mode === 'D') {
    return [
      ...
      { conditions: ['speed.gear3', 'throttle.none'], gear: 3, priority: 85 },
      ...
      { conditions: ['speed.gear4', 'throttle.none'], gear: 4, priority: 83 },
      ...
      { conditions: ['speed.gear5', 'throttle.none'], gear: 5, priority: 81 },
      ...
      { conditions: ['speed.gear7', 'rpm.high', 'throttle.light'], gear: 7, priority: 86 },
      { conditions: ['speed.gear7', 'rpm.high', 'throttle.medium'], gear: 7, priority: 84 },
      { conditions: ['speed.gear7', 'throttle.none'], gear: 7, priority: 83 },
      { conditions: ['speed.gear7', 'rpm.high', 'throttle.high'], gear: 7, priority: 75 },

      // Правила перехода с 6-й на 7-ю
      { conditions: ['speed.gear6', 'rpm.low', 'throttle.none'], gear: 7, priority: 87 },
      { conditions: ['speed.gear6', 'rpm.low', 'throttle.light'], gear: 7, priority: 86 },
      { conditions: ['speed.gear6', 'rpm.medium', 'throttle.light'], gear: 7, priority: 85 },
      { conditions: ['speed.gear6', 'rpm.medium', 'throttle.medium'], gear: 7, priority: 84 },
    ...
    return [
      ...
      { conditions: ['speed.gear2', 'throttle.none'], gear: 2, priority: 84 },
      ...
      { conditions: ['speed.gear3', 'throttle.none'], gear: 3, priority: 84 },
      ...
      { conditions: ['speed.gear4', 'throttle.none'], gear: 4, priority: 82 },
      ...
      { conditions: ['speed.gear5', 'throttle.none'], gear: 5, priority: 80 },
